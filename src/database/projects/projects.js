const projects = [
  {
    ...
    description: `Questa <span class="color-purple">applicazione</span> è un progetto personale che ho sviluppato per creare un <span class="color-purple">blog di videogiochi</span>, 
    attualmente ancora in fase di completamento. <br><br> L'obiettivo principale di questa applicazione è fornire una piattaforma dove gli utenti possano <span class="color-purple">visualizzare</span> i <span class="color-purple">post</span>, <span class="color-purple">aggiungere</span> nuovi contenuti, <span class="color-purple">modificare</span> gli articoli esistenti, e filtrare i <span class="color-purple">post</span> per <span class="color-purple">categoria</span> o per parole chiave nel <span class="color-purple">titolo</span> o nella <span class="color-purple">descrizione breve</span>.<br><br> L'API utilizzata è stata sviluppata interamente da me utilizzando <span class="color-purple">Node.js</span>, <span class="color-purple">Prisma</span> ed <span class="color-purple">Express</span>, assicurando una gestione robusta e performante del backend. Ho anche implementato un sistema di gestione degli <span class="color-purple">errori</span> che permette di rilevarli e utilizzarli nella <span class="color-purple">validazione</span> dei dati direttamente nel frontend.`,
    is_visible: 1,
  ...
  {
    name: "Travel App",
    description: `Questa <span class="color-purple">applicazione</span> è il risultato del lavoro di un team di 5 persone, in cui ho contribuito alla progettazione e sviluppo 
    utilizzando <span class="color-purple">Vue</span> e <span class="color-purple">Inertia</span> su <span class="color-purple">Laravel</span>. 
  ...
  },
  {
    ...
    durante il corso <span class="color-purple">Boolean</span> e successivamente arricchita con funzionalità aggiuntive. Realizzata in <span class="color-purple">Vue</span> 
    , consente di visualizzare <span class="color-purple">chat</span>, filtrare gli utenti, e inviare <span class="color-purple">messaggi</span> con <span class="color-purple">emoticon</span> 
